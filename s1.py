            ...
            if op.type == 26:
                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        #aku = client.getContact().pictureStatus
...
#client.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + aku)
                        else:
                            pass
                    else:
                        pass
                        ...
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                if True:
                                   ...
                                   client.sendText(msg.to,"http://line.me/ti/p/~" + msgg)
